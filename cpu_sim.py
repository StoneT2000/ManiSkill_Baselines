...
def main(args):
    ...
    #         )
        ...
        #     **kwargs
        # )
    env = gym.make_vec(args.env_id, num_envs=args.num_envs, vectorization_mode="async", vector_kwargs=dict(context="spawn"), **env_kwargs)
    # env = gym.make_vec(args.env_id, num_envs=args.num_envs, vectorization_mode="sync", **env_kwargs)
...
def parse_args():
    ...
    parser.add_argument("-n", "--num-envs", type=int, default=16)
